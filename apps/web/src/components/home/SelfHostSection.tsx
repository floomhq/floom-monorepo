...
// Canonical self-host command. Matches the README, self-host docs, and pricing
...
const DOCKER_CMD = 'docker run -p 3051:3051 ghcr.io/floomhq/floom-monorepo:latest';
