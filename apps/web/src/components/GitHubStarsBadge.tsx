...
export function GitHubStarsBadge({
  ...
  // R11 (2026-04-28): Gemini audit — bare "6" badge looked ambiguous on
  // every page (read like a notification or version pill). Add a native
  // `title` tooltip + a star glyph prefix on the visible label so the
  // GH icon + count read unambiguously as "stars".
  const titleText = `${count} stars on GitHub · click to star us`;
