...
const SLUG = 'support-ticket-summarizer';
const DISPLAY_NAME = "Support Ticket Summarizer";
const PORT = Number(process.env.PORT || 15406);
...
const OPENAPI_SPEC = {
  openapi: '3.0.0',
  info: { title: DISPLAY_NAME, version: '1.0.0', description: "Paste a support ticket and get root cause, urgency, owner, and reply draft." },
