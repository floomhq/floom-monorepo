...
const SLUG = 'openanalytics-aeo';
const DISPLAY_NAME = "AEO Analytics";
const PORT = Number(process.env.PORT || 15403);
...
const OPENAPI_SPEC = {
  openapi: '3.0.0',
  info: { title: DISPLAY_NAME, version: '1.0.0', description: "Brand + competitors -> AI answer visibility score and recommendations." },
