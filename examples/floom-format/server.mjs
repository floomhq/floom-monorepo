...
const SLUG = 'floom-format';
const DISPLAY_NAME = "Floom Format";
const PORT = Number(process.env.PORT || 15404);
...
const OPENAPI_SPEC = {
  openapi: '3.0.0',
  info: { title: DISPLAY_NAME, version: '1.0.0', description: "Paste messy text, HTML, or JSON and get clean Markdown plus structured metadata." },
