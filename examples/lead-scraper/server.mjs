...
const SLUG = 'lead-scraper';
const DISPLAY_NAME = "Lead Scraper";
const PORT = Number(process.env.PORT || 15401);
const HOST = process.env.HOST || '127.0.0.1';
const PUBLIC_BASE = process.env.PUBLIC_BASE || `http://${HOST}:${PORT}`;
const REQUIRED = ["country","business_type"];
const SAMPLE_INPUT = {
  "country": "Germany",
...
const OPENAPI_SPEC = {
  openapi: '3.0.0',
  info: { title: DISPLAY_NAME, version: '1.0.0', description: "Country + business type -> public lead table with emails as CSV-ready JSON." },
